...
RSpec.describe 'Posts', type: :system do
  ...
  describe 'POST /create' do
    ...
    context 'when user is not signed in' do
      ...
      let(:invalid_attributes) do
        { prefecture: nil, city: nil, radio_name: nil, zip_code: nil, other_address: nil, legal_name: nil, phone: nil,
          body: nil, segment_id: nil, residence_prefecture: nil, residence_city: nil }
      end
    ...
    context 'when user is signed in' do
      ...
      let(:new_attributes) do
        { prefecture: 'Osaka',
          ...
          segment_id: 2,
          residence_prefecture: 'Osaka',
          residence_city: 'Osaka'
        }
      end
