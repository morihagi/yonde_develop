...
RSpec.describe "Profiles", type: :system do
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        { zip_code: '1234567', prefecture: 'Tokyo', city: 'Chiyoda', other_address: '1-1-1', radio_name: 'Radio', phone: '090-1234-5678', legal_name: 'Legal', residence_prefecture: 'Tokyo', residence_city: 'Chiyoda' }
      }
    ...
    context "with invalid parameters" do
      let(:new_attributes) {
        { zip_code: 'a', prefecture: nil, city: nil, other_address: nil, radio_name: nil, phone: nil, legal_name: nil, residence_prefecture: nil, residence_city: nil }
      }
